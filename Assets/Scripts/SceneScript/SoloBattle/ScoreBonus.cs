...
public class Score : MonoBehaviour
{
    ...
    [Header("▼ 演出")]
    [SerializeField] float BONUS_UI_BOUNCE_SEC = 0.7f;
    ...
    void Start()
    {
        ...
        _startPos = _scoreBonusUI.rectTransform.transform.position;
    }

    void Update()
    {
        // ボーナスが無いなら中断
        if (_currentScoreBonus == _defaultScoreBonus) return;
    ...
    void Direction()
    {
        switch (_direction)
        {
            ...
            case DirectionStep.Enter:
                ...
                _scoreBonusUI.rectTransform.localScale = new(1.0f, 1.0f, 1.0f);
                _bouncingSec = 0.0f;
            ...
            case DirectionStep.Current:
                ...
                _scoreBonusUI.rectTransform.position *= _acceleration;
                _scoreBonusUI.rectTransform.localScale *= _acceleration;
                break;
        }
    }
